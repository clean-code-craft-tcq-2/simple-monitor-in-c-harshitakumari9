...
void test_battery_status(int expectedRange, float actual_temperature, float actual_soc, float actual_charge)
{ 
   int battery_status = Battery_Range_Check(actual_temperature, actual_soc, actual_charge);
