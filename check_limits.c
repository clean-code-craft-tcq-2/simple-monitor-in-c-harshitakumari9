...
void test_battery_status(int expectedRange, float actual_temperature, float actual_soc, float charge_rate, int (*fnPtrForCheckBatteryStatus)(float,float,float))
{ 
